...
/* package ArcoCommunication-0.0.1 */
#define VERSION_ArcoCommunication "0.0.1"
#define MIN_VERSION_ArcoCommunication(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "ArcoCommunication-0.0.1"

#define CURRENT_PACKAGE_KEY "ArcoCommunication-0.0.1"
